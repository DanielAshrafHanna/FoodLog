...
self.addEventListener("fetch", (event) => {
  ...
  // OAuth return must hit the network so config.js?v=dfa2cba, app.js, and PKCE exchange run fresh.
  if (
  ...
  if (
    ...
    url.pathname.endsWith("/config.js?v=dfa2cba")
  ) {
